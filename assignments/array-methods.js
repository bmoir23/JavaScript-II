...
function largeShirt(runners){
    return runners.shirt_size == "L" ;
}
let largeShirts = runners.filter(largeShirt);
console.log(largeShirts);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal array and log the result
let ticketPriceTotal = runners.reduce((donationTotal, donationAmmount)=>{
    return donationTotal + donationAmmount.donation;
},0);
